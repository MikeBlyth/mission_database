...
Family.delete_all
Member.delete_all
zinsser = Factory.create(:family, :last_name=>'Zinsser', :first_name=>'Carl', :sim_id => '500', :country_id => '227')
puts "Zinsser country = #{zinsser.head.country_id}"
blackburn = Factory.create(:family, :last_name=>'Blackburn', :first_name=>'Greg', :sim_id => '501', :country_id => '74')
adler = Factory.create(:family, :last_name=>'Adler', :first_name=>'Fran', :sim_id => '502')
adler.head.sex = 'F'
Factory.create(:member, :family=>zinsser, :sex=>'F', :spouse=>zinsser.head, :first_name=>'Mary', :country_id => '37')
